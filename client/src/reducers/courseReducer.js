...
const addCommentReducer = (state, action) => {
  switch (action.type) {
    case constants.courses.ADD_COMMENT_REQUEST:
      return { loading: true, error: null }
    case constants.courses.ADD_COMMENT_SUCCESS:
      return { loading: false, error: null, comment: action.payload }
    case constants.courses.ADD_COMMENT_FAIL:
      return { loading: false, error: action.payload }
    case constants.courses.ADD_COMMENT_RESET:
      return { loading: false, error: null, message: null }
    default:
      return { ...state }
  }
...
const deleteCommentReducer = (state, action) => {
  switch (action.type) {
    case constants.courses.DELETE_COMMENT_REQUEST:
      return { loading: true, error: null }
    case constants.courses.DELETE_COMMENT_SUCCESS:
      return { loading: false, error: null, message: action.payload }
    case constants.courses.DELETE_COMMENT_FAIL:
      return { loading: false, error: action.payload }
    case constants.courses.DELETE_COMMENT_RESET:
      return { loading: false, error: null, message: null }
    default:
      return { ...state }
  }
