                ...
                <figure>
                 ...
                 <div className="container">
                    <div className={style.privacy__content}>
                        <p className={style.privacy__content_start}>First of all, we welcome you to the online store of (Gendy Tronics Company), 
                        ...
                        <p className={style.privacy__content_header}>First: the information that is collected from you.</p>
                        <ul>
                        ...
                        <p className={style.privacy__content_header}>Second: When do we collect information from you?</p>
                        <ul>
                        ...
                        <p className={style.privacy__content_header}>Third: Where do we use your information?</p> 
                        <ul>
                       ...
                       <p className={style.privacy__content_header}>Fourth: How do we protect your information?</p> 
                        <ul>
