                ...
                <div className="container">
                    <div className={style.contact__wrapper}>
                        ...
                        <form onSubmit={submitFormHandler}>
                            ...
                            <input type="text" name='name' placeholder={strings.contact[lang].name} 
                            onChange={(e) => captureFormDetailsHandler(e)} required/>
                            <input type="text" name='phone' placeholder={strings.contact[lang].phone}
                            onChange={(e) => captureFormDetailsHandler(e)} required/>
                            <input type="email" name='email' placeholder={strings.contact[lang].email} 
                            onChange={(e) => captureFormDetailsHandler(e)} required/>
                            <textarea name="message" placeholder={strings.contact[lang].message} cols="30" rows="10" 
                            onChange={(e) => captureFormDetailsHandler(e)} required></textarea>
                            <button type="submit" 
                            style={{position:'relative', padding:loading && '1rem'}}>
                                {loading ? <Loader size='4' center/> : strings.contact[lang].submit}
                            </button>
                            {(message || error) 
                            &&
                            <Message 
