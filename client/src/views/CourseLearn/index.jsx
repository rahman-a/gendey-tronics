...
const CourseLearn = () => {
  ...
  useEffect(() => {
    ...
    enrollId &&
      !enrollment &&
      dispatch(actions.courses.getEnrollment(id, enrollId))
            ...
            <div className={style.courseLearn__info_wrapper}>
              <ul className={style.courseLearn__info_list}>
                <li
                  ...
                  onClick={() =>
                    history.push(`${path}?enroll=${enrollId}#content`)
                  }
                >
                ...
                <li
                  ...
                  onClick={() =>
                    history.push(`${path}?enroll=${enrollId}#overview`)
                  }
                >
                ...
                <li
                  ...
                  onClick={() =>
                    history.push(`${path}?enroll=${enrollId}#notes`)
                  }
                >
                ...
                <li
                  ...
                  onClick={() =>
                    history.push(`${path}?enroll=${enrollId}#announcement`)
                  }
                >
                ...
                <li
                  ...
                  onClick={() =>
                    history.push(`${path}?enroll=${enrollId}#rating`)
                  }
                >
              ...
              <div
                className={style.courseLearn__info__data}
                    ...
                    <Overview
                      ...
                      data={{
                        ...
                        lessons:
                          ...
                          getLessonsNumber(course.chapters),
                      }}
                    />
                  )
                ) : infoSelected === 'notes' ? (
