...
export const courseApi = {
  ...
  newEnrollment(id, value) {
    return service().post(`courses/${id}/enrollment/new`, { payment: value })
  },
  ...
  listAnnouncementComments(course, announcement) {
    return service().get(
      `courses/${course}/announcements/${announcement}/comments`
    )
  },
  addAnnouncementComment(course, announcement) {
    return service().post(
      `courses/${course}/announcements/${announcement}/comments/add`
    )
  },
  deleteAnnouncementComment(course, announcement) {
    return service().delete(
      `courses/${course}/announcements/${announcement}/comments/delete`
    )
  },
  ...
  addComment(id, comment) {
    return service().post(`courses/${id}/comments/new`, comment)
  },
  deleteComment(id, commentId) {
    return service().delete(`courses/${id}/comments/${commentId}`)
  },
}
