  ...
  return (
    <div className={`${style.footer} footer`}>
        ...
        <div className={style.footer__block}>
          <div className={style.footer__logo}>
            ...
            >
              ...
              <span
                className={style.footer__contact_title}
                style={{
                  transform:
                    lang === 'ar' ? 'translateX(6rem)' : 'translateX(-3rem)',
                }}
              >
          ...
          <div
            className={`${style.footer__line} ${
              lang === 'ar' ? style.footer__line_ar : ''
            }`}
          ></div>
      ...
      <div className={style.footer__copyright}>
        <p>
          {'gendytronics'.toLocaleUpperCase()} &copy; {new Date().getFullYear()}
        </p>
        <p>
          Developed By: <a href='https://abdrahman.dev'>Ahmed Abdelrahman</a>
        </p>
      </div>
    </div>
  )
