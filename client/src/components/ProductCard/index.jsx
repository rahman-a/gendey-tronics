...
const ProductCard = ({card}) => {
    ...
    return (
        <div className={style.productCard}>
            <p className={style.productCard__addToCart} style={{top:`${messagePosition}rem`}}> 
             <span style={{color:'green'}}> <ShoppingCart/> </span> 
            ...
            <div className={style.productCard__option}>
                ...
                <div className={style.productCard__cta}>
                    ...
                    <button onClick={addToCartHandler} disabled={isLoading}>
                        ...
                        { isLoading 
                            ? <Loader size='1'  custom={{padding:0, transform:'translateY(-2px)'}}/>
                            : <span>  <Plus/>  </span>
                        }
                    </button>
                </div>
