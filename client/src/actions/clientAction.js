...
const clientLogin = (info) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.client.LOGIN_SUCCESS,
      payload: {
        info: data.user,
        isAuth: true,
      },
...
const clientGoogleSignIn = (token) => async (dispatch) => {
  ...
  try {
    ...
    localStorage.setItem('expiryAt', data.expiryAt)
    dispatch({
      type: constants.client.GOOGLE_SIGN_IN_SUCCESS,
...
const clientFacebookSignIn = (token) => async (dispatch) => {
  ...
  try {
    ...
    localStorage.setItem('expiryAt', data.expiryAt)
    dispatch({
      type: constants.client.FACEBOOK_SIGN_IN_SUCCESS,
      payload: data.success,
    })
    dispatch({
      type: constants.client.LOGIN_SUCCESS,
...
const clientUpdatePass = (info) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.client.UPDATE_PASSWORD_SUCCESS,
...
const clientVerifyEmail = (info) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.client.VERIFY_EMAIL_SUCCESS,
      payload: data.success,
    })
  } catch (error) {
    dispatch({
...
const clientResetPass = (info) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.client.RESET_PASSWORD_SUCCESS,
      payload: data.success,
    })
  } catch (error) {
    dispatch({
...
const sendResetLink = (info) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.client.RESET_PASSWORD_LINK_SUCCESS,
      payload: data.message,
    })
  } catch (error) {
    dispatch({
...
const clientSearch = (keyword) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.client.USER_SEARCH_SUCCESS,
      payload: data.result,
    })
  } catch (error) {
    dispatch({
...
const pageSliders = (_) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.client.PAGE_SLIDERS_SUCCESS,
...
const getPaypalClientId = (_) => async (dispatch) => {
  dispatch({ type: constants.client.GET_PAYPAL_CLIENT_ID_REQUEST })
  try {
    const { data } = await api.client.paypalClientId()
    dispatch({
      type: constants.client.GET_PAYPAL_CLIENT_ID_SUCCESS,
      payload: data.paypalClientId,
    })
  } catch (error) {
    dispatch({
      type: constants.client.GET_PAYPAL_CLIENT_ID_FAIL,
      payload: error.response && error.response.data.message,
    })
  }
}

const purchasingAssets = (type, assets) => async (dispatch) => {
  dispatch({ type: constants.client.PURCHASING_ASSETS_REQUEST })
  try {
    const { data } = await api.client.createOrder(type, assets)
    dispatch({
      type: constants.client.PURCHASING_ASSETS_SUCCESS,
      payload: data.order,
    })
  } catch (error) {
    dispatch({
      type: constants.client.PURCHASING_ASSETS_FAIL,
      payload: error.response && error.response.data.message,
    })
  }
}
