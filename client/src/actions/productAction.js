...
const getProductData = (id, type) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({type: constants.product.GET_PRODUCT_SUCCESS, payload:data.product})
    } catch (error) {
        dispatch({
...
const listFavouriteProducts = () => async (dispatch) => {
    ...
    try {
        ...
        dispatch({type: constants.product.LIST_FAVOURITE_PRODUCTS_SUCCESS, payload:data.items})
    } catch (error) {
        dispatch({
...
const createOrder = (order) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({type: constants.product.CREATE_ORDER_SUCCESS, payload:data.order})
    } catch (error) {
        dispatch({
...
const listUserOrders = () => async (dispatch) => {
    ...
    try {
        ...
        dispatch({type: constants.product.LIST_ORDERS_SUCCESS, payload:data.orders})
    } catch (error) {
        dispatch({
...
const updateUserOrder = (order) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({type: constants.product.GET_ORDER_SUCCESS, payload:data.order})
        dispatch({type: constants.product.UPDATE_ORDER_SUCCESS, payload:data.order})
    } catch (error) {
        dispatch({
...
const listCartItems = () => async dispatch => {
    ...
    try {
        ...
        dispatch({type:constants.product.LIST_CART_ITEMS_SUCCESS, payload:data.items})
    } catch (error) {
        dispatch({
...
const removeItemFromCart = (id) => async (dispatch, getState) => {
    ...
    try {
        ...
        cartItems = cartItems.filter(item => item._id.toString() !== data.item.toString())
        dispatch({type:constants.product.LIST_CART_ITEMS_SUCCESS, payload:cartItems})
        dispatch({type:constants.product.REMOVE_ITEM_FROM_CART_SUCCESS, payload:data.message})
    } catch (error) {
        dispatch({
...
const clearCart = () => async (dispatch) => {
    ...
    try {
        ...
        dispatch({type:constants.product.CLEAR_CART_SUCCESS, payload:data.message})
    } catch (error) {
        dispatch({
...
const bookCall = (call) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({type:constants.product.BOOK_CALL_SUCCESS, payload:data.message})
    } catch (error) {
        dispatch({
