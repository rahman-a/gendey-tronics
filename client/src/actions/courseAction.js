...
const listAllCourse = (type) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.courses.LIST_ALL_SUCCESS,
...
const getOneCourseChapters = (id) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.courses.LIST_CHAPTERS_SUCCESS,
...
const createNewEnrollment = (id, value) => async (dispatch) => {
  dispatch({ type: constants.courses.NEW_ENROLLMENT_REQUEST })
  try {
    const { data } = await api.courses.newEnrollment(id, value)
    dispatch({
...
const getEnrollmentData = (id, enroll) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.courses.GET_ENROLLMENT_SUCCESS,
...
const controlEnrollmentProgress =
  (courseId, enrollmentId, chapterId, lessonId, type) =>
  async (dispatch, getState) => {
    dispatch({ type: constants.courses.ENROLLMENT_PROGRESS_REQUEST })
    try {
      const { data } = await api.courses.progress(
        courseId,
        enrollmentId,
        chapterId,
        lessonId,
      ...
      dispatch({
        type: constants.courses.ENROLLMENT_PROGRESS_SUCCESS,
        payload: {
...
const listAllCourseNotes = (id) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.courses.LIST_NOTES_SUCCESS,
      payload: data.notes,
    })
  } catch (error) {
    dispatch({
...
const createNewNote = (id, info) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch({
      type: constants.courses.CREATE_NOTE_SUCCESS,
...
const updateNote = (courseId, noteId) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.courses.UPDATE_NOTE_SUCCESS,
      payload: data.message,
    })
  } catch (error) {
    dispatch({
...
const deleteNote = (courseId, noteId) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch({
      type: constants.courses.DELETE_NOTE_SUCCESS,
      payload: data.message,
    })
  } catch (error) {
    dispatch({
...
const listAllAnnouncements = (id) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.courses.LIST_ANNOUNCEMENTS_SUCCESS,
...
const listAllAnnouncementComments =
  (courseId, announcementId) => async (dispatch) => {
    dispatch({ type: constants.courses.LIST_ANNOUNCEMENT_COMMENTS_REQUEST })
    try {
      const { data } = await api.courses.listAnnouncementComments(
        courseId,
        announcementId
      )
      dispatch({
        type: constants.courses.LIST_ANNOUNCEMENT_COMMENTS_SUCCESS,
...
const addAnnouncementComment =
  (courseId, announcementId) => async (dispatch) => {
    ...
    try {
      const { data } = await api.courses.addAnnouncementComment(
        courseId,
        announcementId
      )
      dispatch({
        type: constants.courses.ADD_ANNOUNCEMENT_COMMENT_SUCCESS,
        payload: data.message,
      })
    } catch (error) {
      dispatch({
...
const deleteAnnouncementComment =
  (courseId, announcementId) => async (dispatch) => {
    dispatch({ type: constants.courses.DELETE_ANNOUNCEMENT_COMMENT_REQUEST })
    try {
      const { data } = await api.courses.deleteAnnouncementComment(
        courseId,
        announcementId
      )
      dispatch({
        type: constants.courses.DELETE_ANNOUNCEMENT_COMMENT_SUCCESS,
        payload: data.message,
      })
    } catch (error) {
      dispatch({
...
const addToWishlist = (info) => async (dispatch, getState) => {
  ...
  try {
    ...
    if (course) {
      ...
      dispatch({
        type: constants.courses.GET_ONE_SUCCESS,
        payload: copiedCourse,
      })
    }

    dispatch({
      type: constants.courses.ADD_COURSE_TO_WISHLIST_SUCCESS,
      payload: true,
    })
  } catch (error) {
    dispatch({
...
const removeFromWishlist = (id) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch({
      type: constants.courses.REMOVE_COURSE_FROM_WISHLIST_SUCCESS,
      payload: true,
    })
  } catch (error) {
    dispatch({
...
const listPurchasedCourses = () => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.courses.LIST_PURCHASED_COURSES_SUCCESS,
      payload: data.courses,
    })
  } catch (error) {
    dispatch({
...
const addReview = (review) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.courses.ADD_REVIEW_SUCCESS,
      payload: data.message,
    })
  } catch (error) {
    dispatch({
...
const getReview = (id) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: constants.courses.GET_REVIEW_SUCCESS,
      payload: data.review,
    })
  } catch (error) {
    dispatch({
...
const updateReview = (id, review) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch({
      type: constants.courses.UPDATE_REVIEW_SUCCESS,
      payload: data.message,
    })
  } catch (error) {
    dispatch({
...
const addNewComment = (id, comment) => async (dispatch) => {
  dispatch({ type: constants.courses.ADD_COMMENT_REQUEST })
  try {
    const { data } = await api.courses.addComment(id, comment)
    dispatch({
      type: constants.courses.ADD_COMMENT_SUCCESS,
      payload: data.comment,
    })
  } catch (error) {
    dispatch({
      type: constants.courses.ADD_COMMENT_FAIL,
      payload: error.response && error.response.data.message,
    })
  }
}
...
const deleteComment = (id, commentId) => async (dispatch) => {
  dispatch({ type: constants.courses.DELETE_COMMENT_REQUEST })
  try {
    const { data } = await api.courses.deleteComment(id, commentId)
    dispatch({
      type: constants.courses.DELETE_COMMENT_SUCCESS,
      payload: data.message,
    })
  } catch (error) {
    dispatch({
      type: constants.courses.DELETE_COMMENT_FAIL,
      payload: error.response && error.response.data.message,
    })
  }
}
