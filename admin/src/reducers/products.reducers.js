...
const deleteProductImage = (state, action) => {
  switch (action.type) {
    case constants.products.DELETE_IMAGE_REQUEST:
      return { loading: true, error: null }
    case constants.products.DELETE_IMAGE_SUCCESS:
      return { loading: false, error: null, message: action.payload }
    case constants.products.DELETE_IMAGE_FAIL:
      return { loading: false, error: action.payload }
    case constants.products.DELETE_IMAGE_RESET:
      return { loading: false, error: null, message: null }
    default:
      return { ...state }
  }
