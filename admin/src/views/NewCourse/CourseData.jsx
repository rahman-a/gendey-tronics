      ...
      <Form>
        ...
        <Form.Group className='mb-3' controlId='formBasicDescription'>
          ...
          <Form.Control
            ...
            row={8}
            placeholder={
              course.description || 'type good description for course'
            }
            onChange={(e) => getCourseInfo(e)}
          />
        </Form.Group>
        ...
        <Form.Group controlId='formLanguage' className='mb-3'>
          ...
          <Form.Select name='language' onChange={(e) => getCourseInfo(e)}>
            <option value=''> ..... </option>
            <option value='arabic' selected={course.language === 'arabic'}>
              Arabic
            </option>
            <option value='english' selected={course.language === 'english'}>
              English
            </option>
          </Form.Select>
        </Form.Group>
        ...
        <Form.Group controlId='formFile' className='mb-3'>
          <label className={style.course__upload} htmlFor='hero'>
            {' '}
            {labelString}{' '}
          </label>
          <input
