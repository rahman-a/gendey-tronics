...
const Send = ({ isNewEmail, setIsNewEmail, isReplay, setIsReplay }) => {
  ...
  const isSentEmailOpen = new URLSearchParams(useLocation().search).has(
    'isSent'
  )
      ...
      <Modal show={isNewEmail} onHide={resetCreateEmail}>
        <Modal.Header>
          ...
          <div className={style.support__sender}>
            ...
            >
              ...
              <option value='noreplay@gendyecu.com'>
                noreplay@gendyecu.com
              </option>
        ...
        <Modal.Body>
          <div className={style.support__mail}>
            {isLoading && (
              <div className={style.support__overlay}>
        ...
        <Modal.Footer>
          ...
          <Button variant='secondary' onClick={() => resetCreateEmail()}>
            Discard
          </Button>
        </Modal.Footer>
      </Modal>
