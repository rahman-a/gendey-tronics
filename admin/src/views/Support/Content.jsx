...
import {OverlayTrigger, Popover, Button, Tooltip, Spinner} from 'react-bootstrap'
import {Trash, Star, StarEmpty, BoxArchive, BoxOpen, Replay} from '../../icons'
    ...
    <>
        <div className={style.support__content_header}>
            ...
            <div>
                ...
                >
                    <span onClick={emailReplayHandler}> <Replay/> </span>
                </OverlayTrigger>
                ...
                >
                    <span onClick={() => updateEmail('isStarred')}> 
                     ...
                     : email.isStarred ? <Star/>: <StarEmpty/>
                     } 
                    </span>
                </OverlayTrigger>
                ...
                >
                    <span onClick={() => updateEmail('isArchived')}> 
                    {
                     ...
                     ? <Spinner animation='border' size='sm'/>
                     : email.isArchived ? <BoxArchive/> : <BoxOpen/>
                    } 
                    </span>
                </OverlayTrigger>
