  ...
  return (
    <>
      ...
      <Modal show={confirmDelete} onHide={() => setConfirmDelete(false)}>
        <Modal.Body>
          <p
            className={style.blogs__confirmDelete}
            style={{ fontSize: '2rem' }}
          >
            {' '}
            Are you sure?
          ...
          <p className={style.blogs__confirmDelete}>
            Do You Really want to delete the blog permanently.
          </p>
        </Modal.Body>
        <Modal.Footer>
          <Button
...

      {
        <>
          ...
          <td>
            {blog.seen === 0 ? <Badge bg='dark'> no views </Badge> : blog.seen}
          </td>
          <td>
            ...
            >
              {isDeleting ? (
                ...
                <span
                  ...
                  onClick={() => initiateDeleteProcess(blog._id)}
                >
                  <Times />
                </span>
              )}
