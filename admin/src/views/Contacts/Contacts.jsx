...
const Blogs = () => {
  ...
  const { loading, error, count, contacts } = useSelector(
  ...
  return (
    <div className={style.contacts}>
      ...
      <div className={style.contacts__filter}>
        ...
        <Button variant='warning' size='lg' onClick={searchContactHandler}>
          SEARCH
        </Button>

        <Button variant='dark' size='lg' onClick={resetSearchHandler}>
          RESET
        </Button>
      </div>
            ...
            <tbody>
              {contacts &&
                contacts.map((contact, idx) => (
                  ...
                  >
                    <Row contact={contact} idx={idx + skipValue} />
                  </tr>
                ))}
            </tbody>
          </Table>
