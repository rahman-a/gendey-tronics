...
const CreateSlider = ({isCreateSlide, setIsCreateSlide}) => {
    ...
    <>
        ...
        <Modal show={isCreateSlide} onHide={() => setIsCreateSlide(false)}>
            ...
            <Modal.Body>
            <div className={style.sliders__slider}>
                        {loading && <div className={style.sliders__overlay}>
                        ...
                        <Form>
                            ...
                            <InputGroup className='mb-3'>
                                ...
                                <Form.Control name='header' onChange={(e) => handleInputChange(e)}/>
                            </InputGroup>
                        
                            {/* Slider Sub Header */}
                            <InputGroup className='mb-3'>
                                <InputGroup.Text> Sub Header </InputGroup.Text>
                                <Form.Control name='subHeader' onChange={(e) => handleInputChange(e)}/>
                            </InputGroup>
                            
                            {/* Slider Image */}
                            <InputGroup>
                                <InputGroup.Text> Slider Image </InputGroup.Text>
                                <Form.Control type='file' name='slider' onChange={(e) => handleInputChange(e)}/>
                            </InputGroup>
                            ...
                            <div className={style.sliders__target}>
                                ...
                                <InputGroup className='mb-3' style={{flexShrink:'2'}}>
                                    ...
                                    <Form.Select name='type' onChange={(e) => handleTargetInputChange(e)}>
                                        <option value="">........</option>
            ...
            <Modal.Footer>
                <Button variant="secondary" onClick={() => setIsCreateSlide(false)}>Close</Button>
