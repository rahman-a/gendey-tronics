...
const Courses = () => {
  ...
  const { loading, error, courses, count } = useSelector(
    (state) => state.listAllCourses
  )
  ...
  return (
    <>
      ...
      <Coupons isCoupon={isCoupons} setIsCoupon={setIsCoupons} />
              ...
              <tbody>
                {courses &&
                  courses.map((course, idx) => (
                    <tr key={course._id}>
                      <Row course={course} idx={idx + skipValue} />
                    </tr>
                  ))}
              </tbody>
            </Table>
