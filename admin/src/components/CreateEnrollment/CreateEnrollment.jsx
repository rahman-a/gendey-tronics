  ...
  return (
    <>
      ...
      <Modal show={isEnrollment} onHide={() => setIsEnrollment(false)}>
        ...
        <Modal.Body>
          <div className={`${style.enrollment} font-size-input font-size-span`}>
            {loading && (
              <div className={style.enrollment__overlay}>
        ...
        <Modal.Footer>
          <Button size='lg' variant='success' onClick={createEnrollmentHandler}>
            {' '}
            Create Enrollment{' '}
          </Button>
          <Button
