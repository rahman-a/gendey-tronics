  ...
  return (
    <>
      ...
      <Modal show={isOrder} onHide={() => setIsOrder(false)}>
        ...
        <Modal.Body>
          <div className={`${style.order} font-size-input font-size-span`}>
            {loading && (
              <div className={style.order__overlay}>
            ...
            <Form>
              ...
              <InputGroup className='mb-3'>
                ...
                <Form.Control
                  name='paymentMethod'
                  onChange={(e) => handleInputChange(e)}
                  placeholder='ex: paypal, fawery or vodafone cash'
                />
              </InputGroup>
        ...
        <Modal.Footer>
          ...
          <Button variant='danger' onClick={() => setIsOrder(false)}>
            {' '}
            Cancel{' '}
          </Button>
        </Modal.Footer>
